Public Class DFS
    ...
    Private Sub AddNode4_Click(sender As Object, e As EventArgs)

        Dim namenode = txtAddNode4.Text
        graph.AddNode(namenode)
        txtAddNode4.Clear()
    End Sub

    Private Sub btnAddEdge4_Click(sender As Object, e As EventArgs)
        Dim nodeOrigin = textv1_4.Text
        Dim nodeDest = textv2_4.Text
    ...
    Private Sub seeMatrix4_Click(sender As Object, e As EventArgs)
        MostrarMatrizAdyacencia()
    End Sub

    Private Sub btnDFS_Click(sender As Object, e As EventArgs)
        Dim startNode = txtStartNode2.Text  ' Nodo de inicio que se ingresa en el formulario

        Dim dfsResult = graph.DFS(startNode)

        If dfsResult.Count > 0 Then
    ...
    Private Sub btnDFS_I_Click(sender As Object, e As EventArgs)
        ...
        Dim dfsIterativeResult = graph.DFSIterativo(startNode)

        ' Verificar si hubo un recorrido exitoso
        If dfsIterativeResult.Count > 0 Then
    ...
    Private Sub DeleteNode4_Click(sender As Object, e As EventArgs)
        ' Obtener el nombre del nodo a eliminar
        Dim nodeName = txtdeletenode4.Text
    ...
    Private Sub deleteedge4_Click(sender As Object, e As EventArgs)
        ' Obtener el nodo de origen y destino
        Dim originNode = txtvd_4.Text
        Dim destinationNode = txtvd2_4.Text
